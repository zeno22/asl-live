...
classifier.add(Convolution2D(64, (5, 5), input_shape=(32, 32, 1), activation='relu'))
...
classifier.fit_generator(
        training_set,
        steps_per_epoch=10468, # No of images in training set
        epochs=15,
        validation_data=test_set,
        validation_steps=4450)# No of images in test set
